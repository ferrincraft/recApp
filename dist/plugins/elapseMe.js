...
var elapseMe = 	(function elapseTimer(settings)
	{
		...
		var resultOut = (settings.show == "all" || settings.show.match(/minutes/gi) ) ? elapsedMinutes + ":" :"";
		resultOut += (settings.show == "all" || settings.show.match(/seconds/gi) ) ? ((elapsedSeconds < 10) ? "0":"") + elapsedSeconds :"";
